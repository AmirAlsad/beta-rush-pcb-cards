# Upstream design document — NFC PCB business card

> **Attribution.** Everything below this banner is the original `README.md` from
> **[Raziz1/PCB_Business_Card](https://github.com/Raziz1/PCB_Business_Card)** by
> **Rahim Aziz**, reproduced verbatim (commit `fe6c083`) because it is the
> engineering derivation behind the brother card's antenna and matching network.
> Both Beta cards are forks of that project. Only the relative image paths below
> were rewritten to match this repo's layout — no wording, math, or figure was
> altered.
>
> The upstream repository carries **no explicit license file**. See
> [`OPEN-QUESTIONS.md`](./OPEN-QUESTIONS.md) — asking Rahim for a license grant
> is a loose end worth closing.
>
> **What Beta changed** relative to this document is written up in
> [`../brother-card/README.md`](../brother-card/README.md). The antenna geometry,
> tuning capacitor, LED bias resistor, and all of the theory below were
> *inherited unchanged*.
...
<p align="center">
    <img title="PCB Business Card Render" alt="PCB Business Card" src="./renders/upstream-blender/PCB_Business_Card_Blender.png" width ="75%">
</p>
...
I utilized the [Antenna_Shape_Calculator](./reference/Antenna_Shape_Calculator.xlsx) excel document to calculate the geometric parameters. They were as follows:
* $D_0 = 41mm$
* $t = 35um$
* $w = 300um$
* $g = 300um$
...
<p align="center">
    <img title="MATLAB Antenna Simulation" alt="MATLAB Antenna Simulation" src="./antenna-simulations/MATLAB_Antenna_Simulation/MATLAB_Antenna_Spiral_Image.png" width ="75%">
</p>
<p align="center"><i>MATLAB Archimedean Spiral</i></p>

<p align="center">
    <img title="MATLAB Antenna Simulation" alt="MATLAB Antenna Simulation" src="./antenna-simulations/MATLAB_Antenna_Simulation/MATLAB_3D_Radiation_Image.png" width ="75%">
</p>
<p align="center"><i>MATLAB 3D Radiation Pattern</i></p>

<p align="center">
    <img title="MATLAB Antenna Simulation" alt="MATLAB Antenna Simulation" src="./antenna-simulations/MATLAB_Antenna_Simulation/Matching_Network_Sparameters_Image.png" width ="75%">
</p>
